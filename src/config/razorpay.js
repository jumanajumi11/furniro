...
console.log("RAZORPAY_KEY_ID env:", process.env.RAZORPAY_KEY_ID);
console.log("RAZORPAY_KEY_SECRET env length:", process.env.RAZORPAY_KEY_SECRET ? process.env.RAZORPAY_KEY_SECRET.length : 0);
